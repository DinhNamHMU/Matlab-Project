function jointProbabiliteGamma=jointProbabilite_QPSK_Gamma(bit_Alice,bit_Bob,ScaleCo,P_T_dBm,C2n) 
    ...
    a_G=0.3;                       %The radius of the dection aperture
    ...
    EI0=2*M*R*sqrt(G_Tx*1/FSL*P_T*hl*h_p_G*G_Rx*P_LO);
    EI1=-EI0;
    
    sigmaR2=1.23*(2*pi/lamda_wavelength)^(7/6)*La^(11/6)*C2n;
    ...
    for i=1:length(t)
        a(i)=teta(i)/temp1;     
        for l=1:length(t)
            I0=2*M*R*sqrt(G_Tx*1/FSL*P_T*hl*h_p_G*t(l)/special(i)*G_Rx*P_LO);
            I1=-I0;
