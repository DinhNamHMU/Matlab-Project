function Result=jointProbabilite_QPSK_DD(bit_Alice,bit_Bob,ScaleCo,P_T_dBm,alpha1) 
    ...
    P_R=P_T*h;
    sigmaN2=2*q*M^(2+x)*(1*G_Tx*G_Rx*R+Id)*deltaf+4*kB*T/RL*deltaf;
    I0=0.25*M*R*P_R*G_Tx*G_Rx;
    I1=-0.25*M*R*P_R*G_Tx*G_Rx;
    d0=ScaleCo*I0;
    d1=ScaleCo*I1;
