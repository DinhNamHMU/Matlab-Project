function Result=jointProbabilite_QPSK(bit_Alice,bit_Bob,P_T_dBm) 
    ...
    P_R=P_T*h;
    sigmaN2=2*q*M^(2+x)*(P_LO*R+P_R*G_Tx*G_Rx+Id)*deltaf+4*kB*T/RL*deltaf;
