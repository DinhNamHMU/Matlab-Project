...
B=10;                  %BS buffer size
P_dBm=0:0.2:5;       %Peak transmitted power(dBm)
...
figure(1)
semilogy(P_dBm,keyLossRate1,'b-',P_dBm,keyLossRate2,'r--',P_dBm,keyLossRate3,'k:',P_dBm,keyLossRate4,'g+-',P_dBm,keyLossRate5,'m-*','LineWidth',1.5);
grid on
