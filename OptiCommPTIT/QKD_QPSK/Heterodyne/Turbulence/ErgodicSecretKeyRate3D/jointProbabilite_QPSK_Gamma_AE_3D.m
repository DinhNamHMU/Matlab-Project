function jointProbabiliteGamma=jointProbabilite_QPSK_Gamma_AE_3D(bit_Alice,bit_Bob,X_L_BE_Array,P_T_dBm,C2n) 
    ...
    h_p_G=A_0_G.*exp(-2.*(X_L_BE_Array.^2)./Omega_zeq_G_2);
