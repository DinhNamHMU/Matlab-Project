function jointProbabiliteGamma=jointProbabilite_QPSK_Gamma_AB_3D(bit_Alice,bit_Bob,Y_ScaleCoArray,P_T_dBm,C2n) 
    ...
    for i=1:length(t)
        ...
        for l=1:length(t)
            ...
            d0=EI0+Y_ScaleCoArray.*sqrt(sigmaN_i_l.^2);
            d1=EI1-Y_ScaleCoArray.*sqrt(sigmaN_i_l.^2);
