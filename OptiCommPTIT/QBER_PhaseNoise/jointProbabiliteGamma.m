function Result=jointProbabiliteGamma(bit_Alice,bit_Bob,ScaleCo)
    %Gamma-Gamma channels
    %Simulation Parameters
    
    %Laguerre polynomial weights and abscissas
    %tl-abscissas factor of Laguerre polynomial
    t=[29.920697012274,21.996585811981,16.279257831378,11.843785837900,8.330152746764,5.552496140064,3.401433697855,1.808342901740,0.729454549503,0.137793470540];
    %vl-weight factor of Laguerre polynomial
    v=[0.000000000000991182721961,0.00000000183956482398,0.000000424931398496,0.0000282592334960,0.000753008388588,0.00950151697518,0.0620874560987,0.218068287612,0.401119929155,0.308441115765];
    ...
    C2n=10^-13;               %Refractive index structure coefficient 
