function jointProbabiliteGamma=jointProbabiliteGamma_AB_HAP(bit_Alice,bit_Bob,ModDepth)
    ...
    R=(nguy.*q)./(h.*c./lamda_wavelength);    %Detector responsivity 
    ...
    %ASE noise
    P_a=2.*n_sp.*h.*c./lamda_wavelength.*B0;
